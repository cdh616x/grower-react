...
export default function CloneItem(props) {
  return (
    <>
    <div className="container-fluid">
     <div className="row product-row">
      ...
      <div className="col-7 product-info">
       ...
       <img className="img-fluid clone" src={props.media_img} />
       <img className="img-fluid clone" src={props.media_img1} />
       <img className="img-fluid clone100" src={props.media_img2} />
       <img className="img-fluid cloneh" src={props.media_img3} />
